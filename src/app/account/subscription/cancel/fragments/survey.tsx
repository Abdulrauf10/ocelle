...
export default function SurveyFragment({ navigate }: FragmentProps<Path>) {
  ...
  return (
    <Container>
      ...
      <div className="border-gray mx-auto mt-8 max-w-[1200px] rounded-3xl border bg-white px-14 py-6 shadow-[5px_5px_12px_rgba(0,0,0,.2)] max-lg:px-6 max-lg:py-4">
              ...
              <div className="py-1.5">
                <Controller
                  ...
                  render={({ field }) => (
                    <textarea
                      {...field}
                      className="border-gray h-40 w-full resize-none rounded-2xl border p-3"
                    />
                  )}
                />
              </div>
      ...
      <div className="pb-2 text-center">
        <Controller
          ...
          render={({ field }) => (
            <textarea
              {...field}
              className="border-gray mt-8 h-48 w-full max-w-[1200px] resize-none rounded-3xl border bg-white p-6 shadow-[5px_5px_12px_rgba(0,0,0,.2)]"
            />
          )}
        />
      </div>
