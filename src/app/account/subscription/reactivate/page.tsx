...
function Block({ className, children }: React.PropsWithChildren<BlockProps>) {
  return (
    <div
      className={clsx(
        'border-gray mx-auto max-w-[720px] rounded-2xl border bg-white p-6 shadow-[5px_5px_12px_rgba(0,0,0,.1)]',
        className
      )}
    >
      {children}
...
function Hr() {
  return <hr className="border-gray my-4" />;
}

function SectionTitle({ children }: React.PropsWithChildren) {
  return <strong className="text-gold text-lg">{children}</strong>;
}
        ...
        <Block className="mt-8">
            ...
            <div className="-m-3 flex items-center max-sm:flex-col">
              ...
              <div className="w-full flex-1 p-3">
                <div className="my-2 flex items-center">
                  <div className="text-brown min-w-[150px] text-xl font-bold">Meal Plan:</div>
                  <div className="flex-1 text-right">Fresh [Full] Plan</div>
                </div>
                <div className="my-2 flex items-center">
                  <div className="text-brown min-w-[150px] text-xl font-bold">Recipes:</div>
                  <div className="flex-1 text-right">[Fresh Beef]</div>
                </div>
                <div className="my-2 flex items-center">
                  <div className="text-brown min-w-[150px] text-xl font-bold">Days Of Food:</div>
          ...
          <div className="">
            <div className="-m-3 flex items-center max-sm:flex-col">
              ...
              <div className="w-full flex-1 p-3">
                <div className="my-2 flex items-center">
                  <div className="text-brown min-w-[150px] text-xl font-bold">Delivery:</div>
                  <div className="flex-1 text-right">[Free]</div>
                </div>
                <div className="my-2 flex items-center">
                  <div className="text-brown min-w-[150px] text-xl font-bold">Promo Code:</div>
                  <div className="flex-1 text-right">－</div>
                </div>
                <div className="my-2 flex items-center">
                  <div className="text-brown min-w-[150px] text-xl font-bold">Today’s Total:</div>
