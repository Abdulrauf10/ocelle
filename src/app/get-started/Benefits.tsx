  ...
  return (
    <div className="mt-5 flex flex-wrap justify-center">
      <div className="mt-10 w-[30%] max-w-[400px] p-5 max-lg:w-1/3 max-lg:p-[10px] max-md:w-full">
        <div className="relative h-full rounded-[20px] border border-[#9A9486] p-6">
          ...
          <h3 className="mt-3 text-lg font-bold text-[#9A9486]">Just Real, Good Food</h3>
      ...
      <div className="mt-10 w-[30%] max-w-[420px] p-5 max-lg:w-1/3 max-lg:p-[10px] max-md:w-full">
        <div className="relative h-full rounded-[20px] border border-[#9A9486] p-6">
          ...
          <h3 className="mt-3 text-lg font-bold text-[#9A9486]">Ready To Serve</h3>
      ...
      <div className="mt-10 w-[30%] max-w-[400px] p-5 max-lg:w-1/3 max-lg:p-[10px] max-md:w-full">
        <div className="relative h-full rounded-[20px] border border-[#9A9486] p-6">
          ...
          <h3 className="mt-3 text-lg font-bold text-[#9A9486]">Convenient Deliveries</h3>
