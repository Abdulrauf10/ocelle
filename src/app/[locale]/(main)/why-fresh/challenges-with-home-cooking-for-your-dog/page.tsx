...
export default function ChallengesWithHomeCookingForYourDog() {
  ...
  return (
    <main>
      <Block
        className="bg-[#c9e7e7] bg-[url('/challenges-with-home-cooking-for-your-dog/bg.png')] bg-bottom
        bg-no-repeat
       lang-en:bg-[length:auto_72%] lang-zh:bg-[length:auto_80%] max-md:bg-[length:auto_70%] max-xs:lang-en:bg-[length:auto_58%] max-xs:lang-zh:bg-[length:auto_74%]"
      >
        <Container
          className="lang-en:pb-[clamp(330px,35%,400px)] lang-zh:pb-[clamp(330px,35%,400px)] 
        max-md:lang-zh:pb-[220px] max-sm:lang-zh:!px-1 max-xs:lang-en:pb-[240px] max-xs:lang-zh:pb-[240px]"
        >
