    ...
    <main>
      ...
      <TwoToneBlock
        ...
        className={{
          ...
          bgRight:
            'bg-[#c8d4d0] bg-[url("/raw-dog-food-vs-gently-cooked/food-roulette.jpg")] bg-[length:auto_100%] bg-no-repeat max-md:bg-[url("/raw-dog-food-vs-gently-cooked/food-roulette.jpg")] lg:bg-[-3rem]',
          container: 'py-10',
          mbLeft: 'px-4 py-10',
