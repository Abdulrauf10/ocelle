  ...
  return (
    <main>
      <div className="relative overflow-hidden">
        ...
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 rounded-full bg-white p-6 shadow-black/40 drop-shadow-style-3">
      ...
      <TwoToneBlock
        ...
        className={{
          ...
          bgRight:
            'bg-[#c8d4d0] bg-[url("/raw-dog-food-vs-gently-cooked/food-roulette.jpg")] bg-[length:auto_100%] bg-no-repeat max-lg:bg-[-1.85rem] max-md:bg-[url("/raw-dog-food-vs-gently-cooked/food-roulette.jpg")]',
          container: 'py-10',
          mbLeft: 'px-4 py-10',
        ...
        left={
          <div className="py-24 max-lg:py-0">
            <h2 className="heading-1 heading-weight-1 text-gold  max-lg:text-center">
      ...
      <Block styles="tight" className="bg-dark-green">
        <Container className="text-center text-white">
          <h1 className="heading-1 font-bold lang-zh:font-normal">{i.rich('block-6-title')}</h1>
          <div className="mt-6"></div>
