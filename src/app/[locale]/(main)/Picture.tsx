...
export default function Picture() {
  ...
  return (
    <div className="bg-[#e6e6e6] bg-[url('/home/banner-bg.svg')] bg-[length:auto_100%] bg-center bg-repeat-x">
      <Container className="max-md:px-0">
        <div className="flex flex-wrap items-center max-md:flex-col-reverse">
          <div className="relative flex-1 pr-0 text-primary max-md:w-full max-md:border-t-[10px] max-md:border-primary max-md:p-[30px] max-sm:lang-zh:px-4">
          ...
          <div className="w-[500px] self-end max-xl:w-[375px] max-md:w-full">
            <div className="w-3/4 overflow-hidden max-xl:w-full max-md:m-auto max-md:max-w-[450px]">
              ...
              >
                <Image alt="dog" src="/home/home-banner-dog.png" fill />
              </motion.div>
            </div>
          </div>
        </div>
