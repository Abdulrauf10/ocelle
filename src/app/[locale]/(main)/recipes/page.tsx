...
export default function RecipesPage() {
  ...
  return (
    <main className="overflow-x-hidden">
      <div className="bg-[#4f3b34] bg-[url('./recipes-bg-mb.jpg')] bg-[length:100%_auto] bg-bottom bg-no-repeat py-[55px] max-lg:pb-[55%] lg:bg-[url('./recipes-bg.jpg')] lg:bg-[length:auto_100%] lg:bg-[calc(50%+60px)_center]">
        <Container>
