    ...
    <main>
      <div className="bg-[#E8E4DB]">
        <div className="flex flex-wrap items-center max-lg:flex-col-reverse">
          <div className="w-2/5 py-[4vw] pl-[2vw] text-[20px] text-primary max-lg:w-full">
            ...
            <div className="w-[45%] max-w-[520px] self-stretch p-[30px] max-lg:w-full">
              <div className="relative h-full w-full rounded-[40px] border border-[#269D9E] bg-white px-10 pb-10 pt-[70px] text-center">
                <div className="absolute left-0 top-5 w-full text-center">
                  <div className="inline-block rounded-[30px] bg-[#F2892A] px-[25px] py-[3px] text-center font-['Open_Sans'] text-xl italic text-white">
                    RECOMMENDED
                  </div>
                </div>
      ...
      <Section
        ...
        alt="eating dog"
        heading={<H2 className="mb-[30px] text-center text-primary">When OCELLE Arrives</H2>}
      >
        <Image
          ...
          alt="ocelle truck"
        />
        <p className="mt-[20px] text-[20px]">Get ready for some serious tail-wagging!</p>
        <p className="mt-[20px] text-[20px]">
      ...
      <Block className="bg-[#F8F3EB]">
        <Container>
          <H2 className="mb-[30px] text-center font-bold text-[#be873b]">
            A Paws-itively Simple Subscription
          </H2>
          <div className="mx-auto max-w-[600px] rounded-[30px] bg-white p-[50px] text-center">
            ...
            <Button className="mt-[30px]">Create Your Plan</Button>
          </div>
        </Container>
      </Block>
    </main>
