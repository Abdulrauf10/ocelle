...
export class Initial1716078584045 implements MigrationInterface {
    name = 'Initial1716078584045'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`dog\` (\`id\` int NOT NULL AUTO_INCREMENT, \`name\` varchar(255) NOT NULL, \`sex\` enum ('M', 'F') NOT NULL, \`is_neutered\` tinyint NOT NULL, \`date_of_birth_method\` enum ('Manually', 'Calendar') NOT NULL, \`date_of_birth\` datetime NOT NULL, \`weight\` double(5,2) NOT NULL COMMENT 'KG', \`body_condition\` enum ('Too Skinny', 'Just Right', 'Rounded', 'Chunky') NOT NULL, \`activity_level\` enum ('Mellow', 'Active', 'Very Active') NOT NULL, \`food_allergies\` int NOT NULL, \`current_eating\` set ('Dry', 'Wet', 'Raw', 'Dehydrated', 'Fresh', 'Homemade', 'Other') NOT NULL, \`amount_of_treats\` enum ('None', 'Some', 'Lots') NOT NULL, \`pickiness\` enum ('Picky', 'Good Eater', 'Eat Anything') NOT NULL, \`user_id\` varchar(255) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
